...
class JoshinPlaywrightScraper(PlaywrightBaseScraper):
    def __init__(self):
        super().__init__()
        self.search_url = "https://joshinweb.jp/hobby/pokemon.html"
        self.source_name = 'ジョーシン (joshinweb.jp)'
    ...
    def scrape(self):
        ...
        try:
            ...
            print(f"Error scraping joshin: {e}")
    ...
    def _parse_item(self, item):
        ...
        try:
            ...
            if href and not href.startswith('http'):
                href = 'https://joshinweb.jp' + href

            # 商品名を取得
            title_elem = item.find(['h2', 'h3', 'h4', 'p', 'span', 'a'])
            ...
            # 抽選・予約関連のみ
            if not any(kw in text for kw in ['抽選', '予約', 'BOX', 'ボックス', 'パック', '新発売']):
                return None
...
if __name__ == '__main__':
    scraper = JoshinPlaywrightScraper()
    data = scraper.scrape()
